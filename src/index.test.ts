...
describe("public index exports", () => {
  it("re-exports representative core, dom, flow, store, portal, and svg APIs", () => {
    ...
    expect(typeof vrui.byId).toBe("function");
    ...
    expect(typeof vrui.preventThen).toBe("function");
    expect(typeof vrui.onInterval).toBe("function");
    expect(typeof vrui.onResize).toBe("function");
    expect(typeof vrui.onMount).toBe("function");
    expect(typeof vrui.setStyle).toBe("function");
    ...
    expect(typeof vrui.collectScope).toBe("function");
